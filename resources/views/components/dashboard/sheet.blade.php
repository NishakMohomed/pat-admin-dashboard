<div id="sidebar-content" class="hidden md:hidden fixed z-50 gap-4 bg-sidebar-background text-sidebar-foreground shadow-lg transition ease-in-out inset-y-0 left-0 h-full w-3/4 border-r sm:max-w-sm">
